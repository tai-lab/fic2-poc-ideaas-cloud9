...
module.exports = function (options, imports, register) {
    ...
    var seed = 'a_seed_01';
    var a = signPrivateKey( seed, '/home/tai/.ssh/id_rsa', null);
    var b = verify(a, seed, '/home/tai/.ssh/id_rsa.pub', null);

    connect.useSetup(connect.getModule().basicAuth(function(user, pass){
      log.info("SSH auth with user=" + user + "; pass=" + pass);
      return (verifyStr(a, seed, pass, null));
      //return 'tai' == user && 'azerty5*' == pass;
    }));
